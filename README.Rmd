...
pkg_tbl <- tibble::tibble(
  Type = c("EDA", "Geospatial", "Preprocessing", "Statistics", "Statistics", "Time Series", "Time Series", "Time Series", "Time Series", "Time Series", "Time Series", "Time Series", "Time Series", "Time Series"),
  Function = c("skim_arrow", "add_spatial_lags", "to_js_array", "cles", "get_boot_ci", "add_mase_scale_feat", "add_tsfeatures", "create_dtw_grids", "descale_by_mase", "dtw_dist_gridsearch", "prewhitened_ccf", "scale_by_mase", "test_fable_resids", "test_lm_resids"),
  ...
  comp_pkgs = c("arrow", "spdep", "dataui", "", "", "", "", "dtwclust", "", "dtwclust", "", "", "fable", ""),
