...
pkg_tbl <- tibble::tibble(
  Type = c("EDA", "Geospatial", "Geospatial", "Geospatial", "Preprocessing", "Statistics", "Statistics", "Time Series", "Time Series", "Time Series", "Time Series", "Time Series", "Time Series", "Time Series", "Time Series", "Time Series"),
  Function = c("skim_arrow", "add_spatial_lags", "est_buffernmax", "pooled_temporal_variogram", "to_js_array", "cles", "get_boot_ci", "add_mase_scale_feat", "add_tsfeatures", "create_dtw_grids", "descale_by_mase", "dtw_dist_gridsearch", "prewhitened_ccf", "scale_by_mase", "test_fable_resids", "test_lm_resids"),
  Description = c("Runs a {skimr::skim} type of analysis on an arrow object to get summary statistics",
                  "Adds spatial lags of a numeric variable to a dataframe",
