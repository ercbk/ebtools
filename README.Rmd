...
pkg_tbl <- tibble::tibble(
  Type = c("EDA", "Geospatial", "Geospatial", "Geospatial", "Processing", "Processing", "Statistics", "Statistics", "Time Series", "Time Series", "Time Series", "Time Series", "Time Series", "Time Series", "Time Series", "Time Series", "Time Series"),
  Function = c("skim_arrow", "add_spatial_lags", "est_buffernmax", "pooled_temporal_variogram", "fmt_hl", "to_js_array", "cles", "get_boot_ci", "add_mase_scale_feat", "add_tsfeatures", "create_dtw_grids", "descale_by_mase", "dtw_dist_gridsearch", "prewhitened_ccf", "scale_by_mase", "test_fable_resids", "test_lm_resids"),
  Description = c("Runs a {skimr::skim} type of analysis on an arrow object to get summary statistics with minimal memory usage",
                  "Adds separate orders of spatial lags of a numeric variable to a dataframe",
                  "Estimates the bufferNmax hyperparameter for krigeST",
                  "Computes a pooled temporal variogram",
                  "Smartly formats very small numbers (e.g. p values) with optional highlighting",
                  "Creates js array column",
                  "Calculates the Common Language Effect Size (CLES)",
                  "Simplifies computation of bootstrapped confidence intervals for a statistic by wrapping multiple functions and using sensible defaults.",
  ...
  comp_pkgs = c("arrow", "spdep", "gstat", "gstat", "", "dataui", "", "", "", "", "dtwclust", "", "dtwclust", "", "", "fable", ""),
  function_urls = c("https://ercbk.github.io/ebtools/reference/skim_arrow.html",
                    "https://ercbk.github.io/ebtools/reference/add_spatial_lags.html",
                    "https://ercbk.github.io/ebtools/reference/est_buffernmax.html",
                    "https://ercbk.github.io/ebtools/reference/pooled_temporal_variogram.html",
                    "https://ercbk.github.io/ebtools/reference/fmt_hl.html",
  ...
  package_urls = c("https://arrow.apache.org/docs/r/",
