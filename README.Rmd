...
# <a href='https://blog.rstudio.com/2020/09/15/announcing-the-2020-rstudio-table-contest/'> 2020 RStudio Table Contest Submission </a> by A. Calatroni, S. Lussier & R. Krouse <a href='https://github.com/agstn/RStudio_table_contest_2020'> <i class='fa fa-github'></i> Repo </a>"
...
pkg_tbl <- tibble::tibble(
  ...
  mutate(fun_url = purrr::map2(function_urls, Function, ~htmltools::a(href = .x, .y)),
         fun_url = purrr::map(fun_url, ~gt::html(as.character(.x))),
         pkg_url = purrr::map2(package_urls, comp_pkgs, ~htmltools::a(href = .x, .y)),
         pkg_url = purrr::map(pkg_url, ~gt::html(as.character(.x)))) %>% 
