...
pkg_tbl <- tibble::tibble(
  ...
  Description = c("Runs a {skimr::skim} type of analysis on an arrow object to get summary statistics",
                  ...
                  "Estimates a hyperparameter for krigeST",
                  ...
                  "Simplifies calculation of bootstrapped confidence intervals for a statistic by wrapping multiple functions and using sensible defaults.",
