...
pkg_tbl <- tibble::tibble(
  Type = c("Time Series", "Time Series", "Time Series", "Time Series", "Time Series", "Time Series", "Visualization"),
  Function = c("add_mase_scale_feat", "create_dtw_grids", "dtw_dist_gridsearch", "test_fable_resids", "test_lm_resids", "prewhitened_ccf", "to_js_array"),
